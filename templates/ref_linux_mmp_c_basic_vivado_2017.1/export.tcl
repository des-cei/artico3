...
# VIVADO CONFIGURATION
    ...
    if {[string equal [get_runs -quiet synth_1] ""]} {
        create_run -name synth_1 -part xc7z100ffg900-2 -flow {Vivado Synthesis 2017} -strategy "Vivado Synthesis Defaults" -constrset constrs_1
    } else {
...
# VIVADO CONFIGURATION
    ...
    if {[string equal [get_runs -quiet impl_1] ""]} {
        create_run -name impl_1 -part xc7z100ffg900-2 -flow {Vivado Implementation 2017} -strategy "Vivado Implementation Defaults" -constrset constrs_1 -parent_run synth_1
    } else {
...
# LOW-LEVEL DEPENDENCIES
    ...
    # Add DPR constraints
    add_files -fileset constrs_1 -norecurse $proj_dir/xc7z100.xdc
