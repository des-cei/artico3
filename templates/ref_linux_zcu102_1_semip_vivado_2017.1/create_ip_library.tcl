...
proc import_pcore { repo_path ip_name {libs ""} } {
    ...
    create_project -force $ip_name $temp_dir/$ip_name -part xczu9eg-ffvb1156-2-i
...
import_pcore $ip_repo AXI4_2_command_SEM_v1_00_a ""
import_pcore $ip_repo sem_ultra_0_uart_v1_00_a ""
