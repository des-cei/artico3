...
<a3<end generate>a3>
    ...
    write_bitstream -force -no_partial_bitfile -mask_file -logic_location_file bitstreams/system.bit
    file mkdir [pwd]/bin
...
<a3<=end generate=>a3>
    ...
    # Generate bitstreams
    write_bitstream -force -mask_file -logic_location_file bitstreams/<a3<KernCoreName>a3>.bit
<a3<=generate for SLOTS=>a3>
...
<a3<end generate>a3>
    ...
    # Copy SEMIP-related files
    file mkdir [pwd]/bin/sem
    file mkdir [pwd]/bin/sem/bit
    file copy -force {*}[glob [pwd]/bitstreams/*.bit] [pwd]/bin/sem/bit
    file mkdir [pwd]/bin/sem/msk
    file copy -force {*}[glob [pwd]/bitstreams/*.msk] [pwd]/bin/sem/msk
    file mkdir [pwd]/bin/sem/ll
    file copy -force {*}[glob [pwd]/bitstreams/*.ll] [pwd]/bin/sem/ll
